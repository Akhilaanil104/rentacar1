...
// // // //   @override
// // // //   Widget build(BuildContext context) {
// // // //     // Fallback coordinates for New York if no coordinates are provided
// // // //     double latitude = double.tryParse(car['latitude'] ?? '40.7128') ?? 40.7128;
...
// // // //                     // Tapable Location Text
// // // //                     GestureDetector(
// // // //                       onTap: () => _openMap(latitude, longitude),
// // // //                       child: Text(
// // // //                         'Location: ${car['location'] ?? 'New York, NY'}',
// // // //                         style: TextStyle(fontSize: 20, color: Colors.white70, decoration: TextDecoration.underline),
// // // //                       ),
// // // //                     ),
// // // //                     SizedBox(height: 8.0),
...
// // // //                     // Google Map to Display the Car Location
// // // //                     SizedBox(
// // // //                       height: 200,
// // // //                       child: GoogleMap(
// // // //                         initialCameraPosition: CameraPosition(
...
// // // //   // Function to open Google Maps with given latitude and longitude
// // // //   Future<void> _openMap(double latitude, double longitude) async {
// // // //     final Uri launchUri = Uri(
// // // //       scheme: 'https',
// // // //       host: 'www.google.com',
...
// // class CarDetailsPage extends StatelessWidget {
// //   final DocumentSnapshot car; // Use DocumentSnapshot to get Firebase data

// //   CarDetailsPage({Key? key, required this.car}) : super(key: key);

// //   @override
// //   Widget build(BuildContext context) {
// //     // double latitude = car['latitude'] ?? 40.7128; // Use a default or fetched value
// //     // double longitude = car['longitude'] ?? -74.0060;
...
// //                     SizedBox(height: 8.0),
// //                     Text(
// //                       'This is a beautiful ${car['name']} that provides comfort and style. Perfect for all your driving needs.',
// //                       style: TextStyle(fontSize: 18, color: Colors.white70),
// //                     ),
// //                     SizedBox(height: 24.0),
// //                     Center(
...
//   @override
//   Widget build(BuildContext context) {
//     // Access the GeoPoint data type for coordinates
//     GeoPoint location = car['location'];
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Center(
                      child: ElevatedButton(
                        onPressed: () {
                          // Uncomment this code when BookNowPage is implemented
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) => BookNowPage(car: car,),
                            ),
